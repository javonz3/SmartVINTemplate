        ...
        {tiers.map((tier, tierIdx) => (
          <div
            ...
            className={cn(
              ...
              "rounded-lg px-6 py-8 sm:mx-8 lg:mx-0  h-full flex flex-col justify-between cursor-pointer transition-all duration-300",
              selectedTier === tier.id && !tier.featured
          ...
          >
            {selectedTier === tier.id && (
              <div className="absolute top-4 right-4 w-6 h-6 bg-ios-blue rounded-full flex items-center justify-center">
